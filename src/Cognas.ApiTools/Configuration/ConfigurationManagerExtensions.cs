...
public static class ConfigurationManagerExtensions
{
    ...
    public static IConfigurationBuilder AddAzureKeyVault(this IConfigurationManager configurationManager, int reloadIntervalMinutes = 15)
    {
        ...
        return configurationManager.AddAzureKeyVault(vaultUri, credential, options);
    }
    ...
    public static IServiceCollection BindConfigurationSection<TBind>(this WebApplicationBuilder webApplicationBuilder) where TBind : class
    ...
    public static IConfigurationBuilder ConfigureAppSettings(this IConfigurationManager configurationManager, IWebHostEnvironment environment)
    {
        ArgumentNullException.ThrowIfNull(environment, nameof(environment));
        return configurationManager.AddJsonFile("appsettings.json", false, true)
